...
const HTTPStatusDictionary: { [key: number]: string } = {
  [HTTPStatus.INFO_CONTINUE]: "Continue",
  [HTTPStatus.INFO_SWITCHING_PROTOCOLS]: "Switching Protocols",
  ...
  [HTTPStatus.IM_A_TEAPOT]: "I'm a teapot", // Easter egg
...
export { HTTPStatus, HTTPStatusDictionary };
